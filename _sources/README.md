...
- [Step 1b](notebooks/data_assembly/C01_b_db_assembly_cfr_PAGES2k.ipynb) illustrates how to get the proxy database directly from what is built into the `cfr` codebase. 
